		    ...
		    <div class="clean-profile">
		        <div class="box" id="info">
		            <div class="heading-title">
		                <h4>
		                    <span class="pull-right"><a onclick="" href="#"><i class="fas fa-edit"></i> Editar</a></span>
		            ...
		            <div class="content_view">
		                <div class="white_bg">
		                    ...
		                    <div class="text-center tb10">
		                        <a class="btn btn-primary " onclick="" href="#" ><i
		            ...
		            <div class="content_view">
		                <div class="white_bg">
		                    ...
		                    <div class="text-center">
		                        <a class="btn btn-primary " onclick="" href="#" ><i class="fas fa-edit"></i> Editar Inclusión Laboral</a>
		                    </div>
		                </div>
		            </div>
		        </div>
		        ...
		        <div class="box" id="experience">
		            ...
		            <div class="content_view">
		                ...
		                <div class="white_bg">
		                    ...
		                    <div class="text-center">
		                        <a class="btn btn-primary " onclick="" href="#" ><i class="fas fa-edit"></i> Editar años de experiencia</a>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="content_view">
		                ...
		                <div class="white_bg">
		                    ...
		                    <div class="text-center">
		                        <a class="btn btn-primary " onclick="" href="#" ><i class="fas fa-edit"></i> Editar Emprendimiento</a>
		                    </div>
		                </div>
		            </div>
		            ...
		            <div class="content_view" id="jobs">
		                <h5 class="sub">
		                    ...
		                    <a onclick="" href="#" class="add pull-right"><i class="fa fa-plus-circle"></i> Agregar</a>
		                </h5>
		                <div class="item text-center">
		                    <a onclick="" href="#" class="btn btn-primary add_item " ><i class="fa fa-plus-circle"></i> Agregar trabajo</a>
		                </div>
		            </div>
		        </div>
		        ...
		        <div class="box">
		            ...
		            <div class="content_view">
		                <h5 class="sub" id="educationLevel">
		                    Nivel educacional
		                    <a onclick="" href="#" class="add pull-right"><i class="fa fa-pencil"></i> Editar</a>
		                </h5>
		                <div>
		                    <div class="item text-center">
		                        <a onclick="" href="#" class="btn btn-primary add_item " ><i class="fa fa-pencil"></i> Editar nivel educacional</a>
		            ...
		            <div class="content_view">
		                <h5 class="sub" id="careers">
		                    Educación superior <a onclick="" href="#" class="add pull-right"><i class="fa fa-plus-circle"></i> Agregar</a>
		                </h5>
		                <div class="item text-center">
		                    <a onclick="" href="#" class="btn btn-primary add_item " ><i class="fa fa-plus-circle"></i> Agregar carrera</a>
		                </div>
		            </div>
		            ...
		            <div class="content_view">
		                ...
		                <div class="item text-center">
		                    <a onclick="" href="#" class="btn btn-primary add_item " ><i class="fa fa-plus-circle"></i> Agregar colegio</a>
		                </div>
		            </div>
		            ...
		            <div class="content_view">
		                ...
		                <div class="item text-center">
		                    <a onclick="" href="#" class="btn btn-primary add_item " ><i class="fa fa-plus-circle"></i> Agregar postgrado</a>
		                </div>
		            </div>
		            ...
		            <div class="content_view">
		                ...
		                <div class="item text-center">
		                    <a onclick="" href="#" class="btn btn-primary add_item " ><i class="fa fa-plus-circle"></i> Agregar información adicional</a>
		                </div>
		            </div>
		        ...
		        <div class="box">
		            ...
		            <div class="content_view">
		                ...
		                <div class="item text-center">
		                    <a onclick="" href="#" class="btn btn-primary add_item " ><i class="fa fa-plus-circle"></i> Agregar idioma</a>
		                </div>
		            </div>
		            ...
		            <div class="content_view">
		                ...
		                <div class="item text-center">
		                    <a onclick="" href="#" class="btn btn-primary add_item " ><i class="fa fa-plus-circle"></i> Agregar habilidad</a>
		                </div>
		            </div>
		        </div>
		    </div>
